...
READ_SUMMARIES = {
    ...
    "blueprint_details_get": "Read Blueprint variables, defaults, and components.",
    "anim_blueprint_summary_get": "Read compact animation Blueprint summary.",
    "anim_state_machine_summary_get": "Read AnimBlueprint state machine states, entry, and transitions.",
    ...
    "texture_summary_get": "Read Texture2D dimensions, formats, sRGB, and LOD group.",
    ...
    "material_lint": "Read Python-side material authoring diagnostics without compiling.",
